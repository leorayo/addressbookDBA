  ...
  <div id="bar">
        ...
        <div class="contentText">
            <form method="POST" action="WorkServlet" id="userNotes">
                ...
                <strong>First Name: </strong><input type="text" id="FirstName" name="firstName" value="<c:out value="${requestScope.personFirstName}"/>" placeholder="First Name" >
                <br />
                <strong>Last Name: </strong><input type="text" id="LastName" name="lastName" value="<c:out value="${requestScope.personLastName}"/>" placeholder="Last Name"> 
                <br />
